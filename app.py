...
def ping_monitor():
    ...
    while True:
        ...
        # Optimized for Raspberry Pi - increased timeout to match client interval (10s * 3 = 30s)
        if time_since_last_ping > 30:  # 30 second timeout (increased from 15 seconds)
        ...
        # Increased check interval for Raspberry Pi
        time.sleep(10)  # Check every 10 seconds (increased from 5 seconds)
